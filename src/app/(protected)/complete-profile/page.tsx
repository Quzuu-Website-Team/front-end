    ...
    async function onSubmit(data: z.infer<typeof FormSchema>) {
        ...
        try {
            ...
            const backendProfileComplete =
                result?.account?.is_detail_completed ||
                result?.is_detail_completed ||
                false

            console.log(
                "🔍 Backend profile complete status:",
            ...
            if (backendProfileComplete) {
                console.log(
                    "✅ Backend confirms profile is complete, refreshing data...",
                )
                ...
                console.log(
                    "⚠️ Backend hasn't updated is_detail_completed flag yet",
                )
                console.log(
                    "🔧 Using manual context update and direct redirect",
                )
                ...
                setTimeout(() => {
                    console.log(
                        "🏠 Direct redirect to home page (backend not updated yet)...",
                    )
                    router.push("/")
                }, 2000)
            }
