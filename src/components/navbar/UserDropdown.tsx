    ...
    if (isLoading && !user) {
        return (
            <div className="flex items-center space-x-2">
                <div className="h-8 w-8 bg-slate-300 animate-pulse rounded-full"></div>
                <div className="h-4 w-20 bg-slate-300 animate-pulse rounded hidden sm:block"></div>
                <div className="h-4 w-4 bg-slate-300 animate-pulse rounded"></div>
            </div>
        )
    }
    ...
    if (!isAuthenticated || !user) {
        return (
            <div className="flex space-x-2">
                <Link
                    href="/login"
                    className="text-white bg-primary-600 hover:bg-primary-700 px-4 py-2 rounded-md transition-colors font-medium"
                >
                    Login
                </Link>
                <Link
                    href="/register"
                    className="text-primary-600 bg-white hover:bg-gray-100 px-4 py-2 rounded-md transition-colors font-medium"
                >
                    Register
                </Link>
            </div>
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <button
                ...
                className="flex items-center space-x-2 p-2 md:rounded-full md:bg-white md:hover:shadow-md hover:scale-105 transition-all"
                disabled={isLoading}
            >
