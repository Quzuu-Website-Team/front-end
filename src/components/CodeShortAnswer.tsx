        ...
        <div className="code-display py-8 px-6 bg-slate-950 text-white rounded-md whitespace-pre-wrap">
            ...
            <code>
                <Input
                    ...
                    className={`${getInputStyle(0)} text-foreground ${getInputWidth(0)} h-6 inline p-0 leading-3 focus:ring-transparent text-base border-0`}
                    placeholder=""
                />{" "}
            ...
            <code>
                ...
                <Input
                    ...
                    className={`${getInputStyle(1)} text-foreground ${getInputWidth(1)} h-6 inline p-0 leading-3 focus:ring-transparent text-base border-0`}
                    placeholder=""
                />
                ;
            </code>
